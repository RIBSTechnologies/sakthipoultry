      ...
      <div className="mx-auto max-w-7xl space-y-16 px-4 sm:px-6 lg:px-8">
        ...
        >
          <Reveal className="lg:col-span-6">
            ...
            <h2 className="mt-3 font-display text-3xl font-medium tracking-tight leading-tight sm:text-4xl lg:text-[2.7rem] text-ink">
        ...
        >
          <Reveal className="p-8 sm:p-10 lg:col-span-7 lg:p-12">
            ...
            <h2 className="mt-3 font-display text-3xl font-medium tracking-tight leading-tight sm:text-4xl lg:text-[2.7rem]">
