      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            ...
            <div className="mt-6 max-w-3xl space-y-4 text-base leading-relaxed text-muted">
              <p>
                The health and well-being of birds are important considerations
                within our poultry operations.
              </p>
              <p>
                Our chickens are raised in clean environments with attention to
                their surroundings, nutrition and general well-being. They are
                provided balanced diets consisting of appropriate nutritional
                inputs to support growth and development.
              </p>
            </div>
          </Reveal>
