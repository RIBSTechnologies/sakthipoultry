...
const pillars = [
  ...
  },
  {
    ...
    image: asset("sakthi-poultry-quality-feed-bromix.jpg"),
    icon: Wheat,
  },
  {
    step: "04",
    ...
    image: asset("sakthi-poultry-quality-farm-monitoring.jpg"),
    icon: ClipboardCheck,
  },
  {
    step: "05",
    ...
    image: asset("sakthi-poultry-quality-bird-welfare.jpg"),
    icon: HeartHandshake,
  },
];
        ...
        <div className="mt-12 overflow-hidden rounded-[1.75rem] border border-line bg-white shadow-sm lg:grid lg:grid-cols-12">
          <aside className="relative isolate min-h-[22rem] overflow-hidden lg:col-span-5 lg:min-h-full">
            ...
            <div className="relative flex h-full min-h-[22rem] flex-col justify-end p-7 text-white sm:p-9 lg:min-h-[40rem] lg:p-10">
              ...
              <p className="mt-5 font-display text-3xl leading-tight sm:text-4xl lg:text-[2.7rem]">
                Quality is a chain.
